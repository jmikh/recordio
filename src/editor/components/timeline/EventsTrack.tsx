...
export const EventsTrack: React.FC<EventsTrackProps> = ({
    ...
    return (
        <div className="w-full relative bg-[#252526]" style={{ height: trackHeight }}>
            <div className="absolute left-2 top-0 text-[10px] text-gray-500 font-mono pointer-events-none sticky left-0 z-10">EVENTS</div>
