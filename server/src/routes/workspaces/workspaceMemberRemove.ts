 ...
 *
 * Billing is untouched (seat pre-purchase model,
 * plans/seat-prepurchase-oneshot.md): removing a creator/admin frees
 * their purchased seat for the next invite; the seat count only drops
 * when an admin lowers it on the billing page.
 *
