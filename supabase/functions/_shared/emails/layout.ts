/**
 * Shared email HTML layout used by all transactional emails.
...
interface EmailLayoutOptions {
    ...
    body: string;
    /** Unsubscribe URL (full URL with token) */
    unsubscribeUrl?: string;
}

export function emailLayout({ body, unsubscribeUrl }: EmailLayoutOptions): string {
