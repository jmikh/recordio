...
**Accessed by:** `purge-deleted-videos` edge function, `delete-from-stream` edge function, `upload-to-stream` edge function, `cron_cleanup_stale_uploads` SQL function.
