...
> Per repo planning conventions, save this doc as `plans/typography-standardization-oneshot.md` as the first implementation step (plan mode restricted writing to this path).
